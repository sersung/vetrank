/**
 * insert-generated-retry.mjs
 * Inserts the retry batch of generated questions from map tool output.
 */
...
const raw = readFileSync("/home/ubuntu/generate_vet_questions_retry.json", "utf-8");
...
for (const result of results) {
  ...
  try {
    ...
    // Try to extract valid JSON array from the string
    ...
    if (match) {
      try {
        ...
        console.log(`    Could not recover JSON: ${e2.message}`);
        totalErrors++;
        continue;
      }
    } else {
